...
mainMenu.innerHTML =
`<svg id="${extPrefix}typoIcon" class="${extPrefix}cursor ${extPrefix}d-none" width="24px" height="24px"
    viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <title>Если вы нашли ошибку, пожалуйста, выделите фрагмент текста и нажмите на эту иконку или Ctrl+Enter.</title>
...
<svg id="${extPrefix}typosList" class="${extPrefix}cursor ${extPrefix}d-none ${extPrefix}my-auto" width="24px" height="24px"
    viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
